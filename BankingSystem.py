...
customerNames = ['Vinay Kumar', 'Upender', 'Sathish', 'Chandra Shekhar', 'Praneeth Kumar']
customerPins = ['5656', '4545', '0000', '1234', '7865']
customerBalances = [50000, 100000, 200000, 300000, 500000]
deposition = 0
withdrawal = 0
balance = 0
counter_1 = 1
...
while True:
    ...
    print("*************************************")
    print("=<< 1. Open up an new account         >>=")
